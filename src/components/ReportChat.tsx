          ...
          return (
            <div key={i}>
              <div className={`flex ${msg.role === "user" ? "justify-end" : "justify-start"}`}>
                <div
                  // break-words: replies quote requirement text straight out of
                  // the posting, which is where the URLs are. The attachment
                  // chip below already had this; the bubble itself didn't.
